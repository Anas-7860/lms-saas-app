...
const CompanionForm = () => {
  ...
  <SelectContent>
    {subjects.map((subjects)=>(
      <SelectItem key={subjects} value={subjects} className="capitalize">
        {subjects}
      </SelectItem>
    ))}
  </SelectContent>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <textarea placeholder="for e.g. Derivatives and Integrals" {...field} className="input rounded-xl p-2" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
